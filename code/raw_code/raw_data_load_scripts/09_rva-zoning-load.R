...
# Load in zoning boundries
shape <- readOGR(dsn = "../../../data/temp_data/for_capstone/RichmonZoning/Zoning_District_Types.shp")
...
rva_zoning <- spTransform(shape, CRS = proj4string(rva_bound))

# Save to DB
pgInsert(spatialdb, "rva_zoning", rva_zoning)
